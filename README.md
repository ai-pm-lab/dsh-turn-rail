...
- **轮次导航条**：来自使用 [DeepSeek 官方 Web 端](https://chat.deepseek.com)（scrollNav 轮次导航）的体验——长对话里随时看清"聊到哪、每条说了什么"，希望把这份体验带到 `dsh web`
- **加载动画**：想要一个安静的苹果风进度指示器——12 根放射条逐条相位旋转，等待时不抢注意力

**参考来源**

- DeepSeek 官网网页端轮次导航的交互细节：右侧悬浮、悬停展开面板、消息预览、点击跳转
- Apple 平台进度指示器的视觉语言（放射条 spinner 形态）

> 本插件为社区作品，与 DeepSeek 官方无关，非官方出品。
...
[ai-pm-lab](https://github.com/ai-pm-lab) —— 设计、开发与维护
